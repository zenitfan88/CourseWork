...
5. Не заполнено поле "Номер карты", остальные поля заполнены валидными значениями:
...
6. Не заполнено поле "Месяц", остальные поля заполнены валидными значениями:
...
7. Не заполнено поле "Год", остальные поля заполнены валидными значениями:
...
8. Не заполнено поле "Владелец", остальные поля заполнены валидными значениями:
...
9. Не заполнено поле "CVC/CVV", остальные поля заполнены валидными значениями:
...
10. Поле "Номер карты" заполнено невалидными значениями, остальные поля заполнены валидными значениями:
...
11. Поле "Месяц" заполнено невалидными значениями, остальные поля заполнены валидными значениями:
...
12. Поле "Год" заполнено невалидными значениями, остальные поля заполнены валидными значениями:
...
13. Поле "Владелец" заполнено невалидными значениями, остальные поля заполнены валидными значениями:
...
14. Поле "CVC/CVV" заполнено невалидными значениями, остальные поля заполнены валидными значениями:
